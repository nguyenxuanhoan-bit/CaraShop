                    ...
                    <div class="col-md-6">
                        <div class="single-pro-img">
                            ...
                            <div class="small-img-group">
                                <div class="col-sm-3">
                                    <img src="./assets/img/product/f1.jpg" alt="" class="small-img" width="100%">
                                </div>
                                <div class="col-sm-3">
                                    <img src="./assets/img/product/f2.jpg" alt="" class="small-img" width="100%">
                                </div>
                                <div class="col-sm-3">
                                    <img src="./assets/img/product/f3.jpg" alt="" class="small-img" width="100%">
                                </div>
                                <div class="col-sm-3">
                                    <img src="./assets/img/product/f4.jpg" alt="" class="small-img" width="100%">
                                </div>
                            </div>
                        </div>
                    </div>
